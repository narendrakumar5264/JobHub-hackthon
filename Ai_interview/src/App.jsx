    ...
    try {
      ...
      mediaRecorder.onstop = () => {
        ...
        if (videoRef.current) {
          ...
          videoRef.current.src = url; // Play the recorded video
  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-gray-300 mb-4 text-center max-w-lg">
        Welcome to the AI-powered interview system. Please select an option to
        begin your interview. Ensure your microphone and camera (if applicable)
        are enabled.
      </p>
